...
var spin1 = [
				[5,3,3,3,4,3,2,8,5,8,9,3,5,5,5,1,11,9], //reel1
				[4,2,3,3,6,7,2,8,5,3,5,3,5,10,11,2,3,11],  //reel2
				[1,3,2,8,6,5,2,8,5,6,9,10,5,5,1,11,13,12], //reel3
				[6,4,9,3,3,7,2,8,10,5,9,3,5,10,2,12,1,3], //reel4
				[5,1,13,2,9,7,2,5,5,10,9,3,5,5,12,5,2,4] //reel5
			];

var spin2 = [
				[4,6,10,5,9,7,2,7,7,5,9,3,5,2,5,3,3,3],
				[5,10,5,13,3,7,2,8,10,2,9,3,5,6,4,2,3,3],
				[3,1,1,1,4,7,10,8,5,8,9,3,5,8,1,3,2,8],
				[6,1,1,2,5,7,2,8,4,10,2,3,5,1,6,4,9,3],
				[4,2,3,11,6,7,10,8,7,4,9,3,5,5,5,1,13,2]
			];

var spin3 = [
				[3,11,11,11,2,7,2,8,2,5,10,3,5,3,4,6,10,5],
				[1,7,4,1,2,7,10,8,7,8,9,3,5,4,5,10,5,13],
				[4,11,6,11,5,6,2,8,3,8,9,3,5,2,3,1,1,1],
				[6,2,13,6,3,7,2,8,2,3,10,3,5,7,6,1,1,2],
				[1,11,11,11,6,2,10,8,2,6,9,3,5,2,4,2,3,11]
			];

var spin4 = [
				[3,11,11,11,5,7,2,8,6,6,9,3,5,3,3,11,11,11],
				[1,7,4,1,4,1,10,8,7,2,9,3,5,6,1,7,4,1],
				[4,11,6,11,3,7,2,8,8,4,9,8,5,5,4,11,6,11],
				[6,2,13,6,3,10,2,8,3,10,10,3,5,2,6,2,13,6],
				[1,11,11,11,6,7,2,8,3,6,9,10,6,7,1,11,11,11]
			];
...
for (var r = 1; r <= 5; r++) {
	for (var e = 1 ; e <=18 ; e++) {
		var element = "reel" + r + "-" + e;  
		// var currentReel
		document.getElementById(element).style.top =(e-1)*154 + "px" ;
	};
};
...
var spin = function (){
	...
	setTimeout(function(){
		if(totalSpin===1){
			...
			document.getElementById("reel3-16").className += " blinkimage";
			document.getElementById("reel4-18").className += " blinkimage";
	...
	setTimeout(function(){
		if (totalSpin===3){
		 	slightOfHand(spin4);
		 	document.getElementById("reel1-16").className += " expendimage";
		 	document.getElementById("reel1-17").className += " expendimage";
			document.getElementById("reel1-18").className += " expendimage";
			document.getElementById("reel3-16").className += " expendimage";
			document.getElementById("reel3-18").className += " expendimage";
...
var clearEffect1 = function(){
 	document.getElementById("reel1-16").className = "image3";
	document.getElementById("reel2-18").className = "image3";
	document.getElementById("reel3-16").className = "image3";
	document.getElementById("reel4-18").className = "image3";
	document.getElementById("effect1").style.display="none";
}
